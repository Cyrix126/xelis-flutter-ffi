...
if [ "$IS_ARM" = true ]  ; then
    ...
    cp target/aarch64-unknown-linux-gnu/release/libxelis_flutter.so ../../../../linux/bin/aarch64-unknown-linux-gnu/release/
else
    ...
    cp target/x86_64-unknown-linux-gnu/release/libxelis_flutter.so ../../../../linux/bin/x86_64-unknown-linux-gnu/release/
fi
